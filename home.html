...
<html>
	...
	<body>
		...
		<!-- Header -->
			<header id="header">
				<div class="inner">
					<a href="index.html" class="logo" id="logo"> yêu côooo         </a>
					<nav id="nav">
						<a href="index.html">Giới thiệu</a>
						<a href="generic.html">Hệ thống chữa cháy</a>
						<a href="elements.html">Hệ thống báo cháy</a>
												<a href="elements.html">Dịch vụ</a>
						<a href="elements.html">Tuyển dụng</a>
						<a href="elements.html">Liên hệ</a>
		...
		<!-- One -->
			<section id="one">
				<div class="inner">
					<header>
						<h2 style="color: #000000">CÔNG TY THƯƠNG MẠI DỊCH VỤ CHO HƯƠNG</h2>
					</header>
					<p>Hồng.</p>
					<ul class="actions">
